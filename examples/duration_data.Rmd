...
head(df_obs_agg)
```
total_event_time is the total duration of social events, num_events is the number of social events, and total_obs_time is the total duration of observations.
